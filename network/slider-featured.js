...
import SliderFeaturedItem from './slider-featured-item';

class WpSliderFeatured extends React.Component {
        ...
        {this.props.list &&
          ...
          {!this.state.items
            ...
            this.state.items.map(function (item, index) {
              ...
              return (<SliderFeaturedItem key={item.ID} item={item} active={active} imageRender='back' imageSize={this.state.options.listImgSize} imageLink={this.props.imageLink} showContent={this.props.showContent} template={this.props.template} />)
            }.bind(this))
          }
          </div>
        }
        ...
        <div className='page'>
          {!this.state.current
            ...
            this.state.current.items.map(function (item, index) {
              return (
                <SliderFeaturedItem key={item.ID} item={item} debug={this.props.debug} active={true} imageRender='back' imageSize={this.state.options.pageImgSize} imageLink={this.props.imageLink} showContent={this.props.showContent} template={this.props.template} />)
            }.bind(this))
          }
        </div>
...
export default WpSliderFeatured;
